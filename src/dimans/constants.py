...
electron_mass = (
    9.109383701528 * 10 ** -31
) * _si.kilogram
proton_mass = (
    1.6726219236951 * 10 ** -27
) * _si.kilogram
neutron_mass = (
    1.6749274980495 * 10 ** -27
) * _si.kilogram
muon_mass = (
    1.88353162742 * 10 ** -28
) * _si.kilogram
...
w_to_z_mass_ratio = .8815317
weak_mixing_angle = .2229030
...
atomic_mass_of_carbon_12 = (
    1.922_646_879_9260 * 10 ** -26
) * _si.kilogram
